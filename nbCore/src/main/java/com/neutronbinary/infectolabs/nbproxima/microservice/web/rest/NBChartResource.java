...
import com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBChart;
import com.neutronbinary.infectolabs.nbproxima.microservice.repository.NBChartRepository;
...
/**
 * REST controller for managing {@link com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBChart}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NBChartResource {
    ...
    private static final String ENTITY_NAME = "nbCoreNbChart";
