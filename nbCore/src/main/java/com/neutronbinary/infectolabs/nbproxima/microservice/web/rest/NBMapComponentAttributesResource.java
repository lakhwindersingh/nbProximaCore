...
import com.neutronbinary.infectolabs.nbproxima.microservice.repository.NBMapComponentAttributesRepository;
...
/**
 * REST controller for managing {@link com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBMapComponentAttributes}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NBMapComponentAttributesResource {
    ...
    private static final String ENTITY_NAME = "nbCoreNbMapComponentAttributes";
