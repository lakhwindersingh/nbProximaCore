...
import com.neutronbinary.infectolabs.nbproxima.microservice.repository.NBMapRepository;
...
/**
 * REST controller for managing {@link com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBMap}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NBMapResource {
    ...
    private static final String ENTITY_NAME = "nbCoreNbMap";
