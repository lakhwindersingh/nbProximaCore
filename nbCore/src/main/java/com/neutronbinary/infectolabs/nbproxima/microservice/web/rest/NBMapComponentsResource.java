package com.neutronbinary.infectolabs.nbproxima.microservice.web.rest;

import com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBMapComponents;
import com.neutronbinary.infectolabs.nbproxima.microservice.repository.NBMapComponentsRepository;
import com.neutronbinary.infectolabs.nbproxima.microservice.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBMapComponents}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NBMapComponentsResource {
    ...
    private static final String ENTITY_NAME = "nbCoreNbMapComponents";
