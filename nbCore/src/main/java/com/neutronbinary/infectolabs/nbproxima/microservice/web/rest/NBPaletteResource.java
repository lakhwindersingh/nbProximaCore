...
import com.neutronbinary.infectolabs.nbproxima.microservice.repository.NBPaletteRepository;
...
/**
 * REST controller for managing {@link com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBPalette}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NBPaletteResource {
    ...
    private static final String ENTITY_NAME = "nbCoreNbPalette";
