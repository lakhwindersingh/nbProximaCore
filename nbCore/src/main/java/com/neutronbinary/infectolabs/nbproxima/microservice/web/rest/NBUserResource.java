...
import com.neutronbinary.infectolabs.nbproxima.microservice.repository.NBUserRepository;
...
/**
 * REST controller for managing {@link com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NBUserResource {
    ...
    private static final String ENTITY_NAME = "nbCoreNbUser";
