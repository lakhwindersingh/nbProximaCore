...
import com.neutronbinary.infectolabs.nbproxima.microservice.repository.NBMapAttributesRepository;
...
/**
 * REST controller for managing {@link com.neutronbinary.infectolabs.nbproxima.microservice.domain.NBMapAttributes}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NBMapAttributesResource {
    ...
    private static final String ENTITY_NAME = "nbCoreNbMapAttributes";
