...
To build the final jar and optimize the nbProximaCore application for production, run:
...
Then navigate to [http://localhost:9797](http://localhost:9797) in your browser.
